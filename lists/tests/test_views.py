...
class NewListViewUnitTest(unittest.TestCase):
    ...
    @patch('lists.views.redirect')
    def test_saves_form_with_owner_if_form_is_valid(self,mock_redirect, mockNewListForm):
    ...
    @patch('lists.views.redirect')
    def test_redirects_to_form_returned_object_if_form_is_valid(self, mock_redirect, mockNewListForm):
        mock_form = mockNewListForm.return_value
        mock_form.is_valid.return_value = True
    ...
    def test_redirects_to_form_returned_object_if_form_is_invalid(self, mock_render, mockNewListForm):
...
class MyListsTest(TestCase):
    ...
    def test_my_lists_urls_renders_my_lists_template(self):
